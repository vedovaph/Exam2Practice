...
def run_test_practice_problem2a():
    ...
    print('actual', practice_problem2a([0, 1, 2, 3, 4], 6))

    # Test 3:
    print('expected', [15, 16, 17, 18, 19])
    print('actual', practice_problem2a([10, 11, 12, 13, 14], 5))

    # Test 4:
    print('expected', [1, 2, 3, 4, 5])
    print('actual', practice_problem2a([0, 1, 2, 3, 4], 1))
